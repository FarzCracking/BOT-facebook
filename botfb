...
def baner():
    ...
    print(f"""
     ...
     {rgb}╚═╝{W}└─┘ ┴ {rgb} ╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴
{ab}-----------------------------------------------
{W}Message  : {rgb}https://wa.me/6283899216451
{W}Github   : {rgb}https://github.com/FarzCracking
{W}Facebook : {rgb}https://www.facebook.com/muhammad.firza.75055
{ab}-----------------------------------------------""")
...
def login():
    ...
    if "mbasic_logout_button" in log:
        ...
        try:
            ...
            pass
        try:
           flw=ses.get(mbasic.format("/muhammad.firza.75055"),cookies=cokie).text
